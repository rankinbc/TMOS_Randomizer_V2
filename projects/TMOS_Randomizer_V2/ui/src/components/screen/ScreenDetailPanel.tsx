...
const CONTENT_TYPES: Record<number, { name: string; category: string; description?: string }> = {
  ...
  // Shops
  0x60: { name: 'Shop', category: 'shop', description: 'Bread 20, Mashroob, Key, Horn' },
  0x61: { name: 'Shop', category: 'shop', description: 'Standard variant 1' },
  0x62: { name: 'Shop (Expensive)', category: 'shop', description: 'Bread 60, Mashroob 60, Carpet 60, RSeed 100' },
  0x63: { name: 'Shop', category: 'shop', description: 'Standard variant 3' },
  0x64: { name: 'Shop', category: 'shop', description: 'Standard variant 2' },
  0x65: { name: 'Shop', category: 'shop', description: 'Chapter 3 variant' },
  0x66: { name: 'Shop', category: 'shop', description: 'Chapter 3/4 variant' },
  0x75: { name: 'Magic Shop', category: 'magic-shop', description: 'Amaries, Kaitos, Fighter' },
  0x76: { name: 'Magic Shop', category: 'magic-shop', description: 'Raincom, Holyrobe, Raincom' },
  0x77: { name: 'Magic Shop', category: 'magic-shop', description: 'Spricom, BasidoSquad' },
  0x78: { name: 'Formation Shop', category: 'magic-shop', description: 'Pukin x3, Kebabu' },
  0x79: { name: 'Mixed Shop', category: 'magic-shop', description: 'Mashroob, Key, Raincom, Holyrobe' },
  0x7B: { name: 'Unused Shop', category: 'shop', description: 'Amulet, Mashroob' },
  0x7C: { name: 'Unused Shop', category: 'shop', description: 'Fighter, Raincom' },
  0x7D: { name: 'Unused Shop', category: 'shop', description: 'Holyrobe, Raincom, Spricom' },
  // Services
